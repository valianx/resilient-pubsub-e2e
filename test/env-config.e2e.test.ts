 ...
 * correctly against the real library build, not a mock. No emulator interaction
 * is needed for this suite; the emulator connection is skipped.
 *
 * Emulator note: `beforeAll` / `afterAll` hooks are omitted because this suite
 * does not create any Pub/Sub resources.
 */
